...
class HospitalManagementGUI:
    ...
    def opd_options(self):
        self.save_current_section(self.opd_options)
        ...
        ttk.Button(self.root, text="Consultation", width=20, style="TButton").pack(pady=5)
        ttk.Button(self.root, text="Day Care Treatment", width=20, style="TButton").pack(pady=5)
        ttk.Button(self.root, text="Investigations", width=20, style="TButton").pack(pady=5)
        ttk.Button(self.root, text="Referrals", width=20, style="TButton").pack(pady=5)
        ttk.Button(self.root, text="Admissions", width=20, style="TButton").pack(pady=5)
        ttk.Button(self.root, text="Post Discharge Follow Up", width=20, style="TButton").pack(pady=5)
        ttk.Button(self.root, text="Health Check Ups", width=20, style="TButton").pack(pady=5)
        ttk.Button(self.root, text="Immunizations", width=20, style="TButton").pack(pady=5)
        ttk.Button(self.root, text="Physio-Therapy", width=20, style="TButton").pack(pady=5)
