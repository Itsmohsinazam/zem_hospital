...
def user_screen():
    ...
    # Buttons
    CTkButton(root, text='Patient', cursor='hand2', font=('Times New Roman', 25, 'bold'), width=180, command=go_to_patient_screen).place(x=120, y=170)
    CTkButton(root, text='Visitor', cursor='hand2', font=('Times New Roman', 25, 'bold'), width=180, command=call_visitor).place(x=120, y=220)
    CTkButton(root, text='Add Suggestion', cursor='hand2', font=('Times New Roman', 25, 'bold'), width=180,command=call_sug).place(x=120, y=270)
    CTkButton(root, text='Doctor', cursor='hand2', font=('Times New Roman', 25, 'bold'), width=180,command=call_doc).place(x=120, y=320)
...
def suggestion_screen():
    ...
    CTkLabel(window, text="Your Suggestion",
             font=("Arial", 30, "bold"),
             text_color="white").pack(pady=20)
